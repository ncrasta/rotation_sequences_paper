...
save('data/FixedConeData.mat','FixedCone_Posn');
save('data/PolarFixedConeData.mat','PolarFixedCone_Posn');
save('data/MovingConeData.mat','MovingCone_Posn');
save('data/PolarMovingConeData.mat','PolarMovingCone_Posn');
