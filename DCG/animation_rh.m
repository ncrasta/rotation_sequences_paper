...
load FixedConeData.mat
load PolarFixedConeData.mat
load MovingConeData.mat
load PolarMovingConeData.mat
...
vid = 1;
if(vid == 1)
  animation = VideoWriter('RH_TheoremCombined.mp4', 'MPEG-4');
  open(animation);
end
